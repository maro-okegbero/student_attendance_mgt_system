# Generated by Django 3.2.4 on 2021-06-04 00:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fullname', models.CharField(blank=True, max_length=500, null=True, unique=True)),
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], max_length=6, null=True)),
                ('staff_id', models.CharField(blank=True, default='AM-2021-6-NTCIDZRN4', max_length=6, null=True)),
